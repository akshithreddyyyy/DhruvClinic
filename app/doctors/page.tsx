        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link
                href="/doctors"
                className="text-blue-600 font-semibold cursor-pointer whitespace-nowrap"
              >
                Our Doctors
              </Link>
              <Link
                href="/from-our-doctors"
                className="text-gray-700 hover:text-blue-600 transition-colors cursor-pointer whitespace-nowrap"
              >
                From Our Doctors
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our pediatric specialist brings decades of experience and
              expertise to provide exceptional child healthcare
            </p>
          </div>
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="space-y-4 text-gray-700 mb-8">
                  <p className="text-lg leading-relaxed">
                    Dr. E N Purushothama Reddy is a highly experienced
                    pediatrician with over 15 years of dedicated service in
                    child healthcare. Known for his compassionate approach and
                    excellent patient care, he has been serving families in the
                    Sainikpuri area with distinction.
                  </p>
                  <p className="text-lg leading-relaxed">
                    He maintains a 5.0-star rating with 71 patient reviews,
                    reflecting his unwavering commitment to providing
                    exceptional pediatric care and establishing lasting
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Emergency and intensive care for children
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">
                      Restless Child Disorder
                    </h4>
                    <p className="text-gray-600 text-sm">
                      Sleep and attention disorder management
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">
                      Excellence in Pediatric Care Award 2023
                    </h4>
                    <p className="text-gray-600 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Milestone in pediatric healthcare delivery
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Voted by patients and families
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">
                      5.0★ Rating with 71 Reviews
                    </h4>
                    <p className="text-gray-600 text-sm">
                      Consistent excellence in patient satisfaction
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our dermatologist combines advanced training with aesthetic
              expertise for comprehensive skin care
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  MBBS, MD (Dermatology), Advanced Aesthetics Training
                </p>
                <div className="space-y-4 text-gray-700 mb-8">
                  <p className="text-lg leading-relaxed">
                    Dr. Swetha Reddy is a skilled dermatologist and
                    cosmetologist with 17 years of experience in healthcare,
                    specializing in aesthetic medicine. Located in Sainikpuri,
                    Hyderabad, she has received advanced training from Germany.
                  </p>
                  <p className="text-lg leading-relaxed">
                    She provides expert care in dermatology and cosmetic
                    treatments with a 4.6★ rating from 35 patient reviews and
                    maintains a consultation fee of ₹300. Recognized as the
                    "Most Promising Dermatologist from Hyderabad 2016".
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Medical Council of India Registration: 72356-MCI-2001
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">
                  ...
                  <p className="text-gray-600">
                    Specialized training in dermatological sciences
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">
                  ...
                  <p className="text-gray-600">
                    Advanced training from Germany
                  </p>
                  <p className="text-sm text-gray-500">
                    International certification in aesthetic procedures
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Regional recognition for excellence in dermatology
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Advanced training from Germany in aesthetic medicine
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Consistent patient satisfaction with 35 reviews
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Extensive experience in dermatology and cosmetology
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Experience expert medical care with our dedicated doctors
            specializing in pediatrics and dermatology.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Providing exceptional pediatric and dermatological care with
                compassion and expertise. Your health is our priority.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start text-gray-400">
                  ...
                  <span>
                    Plot No 44, Opposite United Church
                    <br />
                    Nirmal Nagar Cross Road, Sainikpuri-500094
                  </span>
                </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">
                {" "}
                2024 Dhruv Clinic. All rights reserved.
              </p>
